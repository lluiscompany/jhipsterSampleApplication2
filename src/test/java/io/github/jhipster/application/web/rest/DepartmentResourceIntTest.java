...
public class DepartmentResourceIntTest {
    ...
    private static final String DEFAULT_DEPARTMENT_NAME_2 = "AAAAAAAAAA";
    private static final String UPDATED_DEPARTMENT_NAME_2 = "BBBBBBBBBB";
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department()
            ...
            .departmentName2(DEFAULT_DEPARTMENT_NAME_2);
        return department;
    }
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getDepartmentName2()).isEqualTo(DEFAULT_DEPARTMENT_NAME_2);
    }
    ...
    @Test
    @Transactional
    public void checkDepartmentName2IsRequired() throws Exception {
        int databaseSizeBeforeTest = departmentRepository.findAll().size();
        // set the field null
        department.setDepartmentName2(null);
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].departmentName2").value(hasItem(DEFAULT_DEPARTMENT_NAME_2.toString())));
    }
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.departmentName2").value(DEFAULT_DEPARTMENT_NAME_2.toString()));
    }
    ...
    public void updateDepartment() throws Exception {
        ...
        updatedDepartment
            ...
            .departmentName2(UPDATED_DEPARTMENT_NAME_2);
        ...
        assertThat(testDepartment.getDepartmentName2()).isEqualTo(UPDATED_DEPARTMENT_NAME_2);
    }
